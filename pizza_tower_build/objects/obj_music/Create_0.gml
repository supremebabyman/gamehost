...
// D mentioned he removed this
// but works with some modification, so yeah
add_music(Mainmenu, "event:/music/title", noone, false, function(room, parameter)
{
	fmod_event_instance_set_parameter(parameter, "state", 0, true);
});

// For NEW Level Select
add_music(NEWLEVELSELECT, "event:/music/levelselect/funni_lario", noone, false);
//
...
// for when failing a level, but you entered using Level Select
add_music(tower_ruinsecret, "event:/music/hub", "event:/music/pillarmusic", false, hub_state)
//
