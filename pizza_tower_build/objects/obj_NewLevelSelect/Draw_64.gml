...
// Should remove HighScore for Boss Rooms
if (boss_room != true)
	draw_text(SCREEN_WIDTH / 2, yy - 38, ini_read_real("Highscore", _levelinfo[2], 0));
// Should Remove Toppin Icons for Bosses
if (boss_room != true)
{	
...
// Remove Treasure Icons for Bosses
if (boss_room != true)
{
	if (!ini_read_real("Treasure", _levelinfo[2], false))
		...
		c = c_white;
	draw_sprite_ext(spr_treasure1, treasure_frame, 587, yy + 26, 1, 1, 0, c, 1);
}

draw_set_font(lang_get_font("smallfont"));
var sf = ini_read_real("Secret", _levelinfo[2], false);
// Remove Secret Text for Bosses
if (boss_room != true)
