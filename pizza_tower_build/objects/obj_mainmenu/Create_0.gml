...
scr_init_input();
// added cuz it needs to be OR ELSE
global.mmenuenable = 0;
...
// on load it alllows credits to be unlocked
// step should lock it when file is selected
global.creditslocked = 0;
