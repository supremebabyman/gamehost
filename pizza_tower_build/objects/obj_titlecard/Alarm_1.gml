...
// for Level Select
else if titlecard_sprite == spr_levelselect_titlecard
{
	// Noise Heads
	//		   X,   Y, Range of Difference
	_add_spot(554, 359, 0.93);
	// ^ Peppino TV
	_add_spot(351, 164, 0.93);
	// ^ Falling Noise
	_add_spot(74, 425, 0.3);
	// ^ Rat
	_add_spot(507, 462, 0.22);
	// ^ Gustavo TV
}
else
{
