if DEBUG
{
	if (keyboard_check_pressed(vk_f8) || keyboard_check_pressed(vk_control))
		DoCommand("SHOWDEBUGOVERLAY");
	if (keyboard_check_pressed(vk_f6) || keyboard_check_pressed(vk_alt))
	{
		DoCommand("SWITCHCHAR");
	}
	if (keyboard_check_pressed(vk_f5) || keyboard_check_pressed(vk_tab))
	{
		active = !active;
		keyboard_string = "";
	}
	...
	{
		var _search = false;
		if (keyboard_check(vk_anykey) && !keyboard_check(vk_f5) || !keyboard_check(vk_tab))
		{
