function scr_initinput(open_savedata = true)
{
	...
	tdp_input_ini_read("menu_start", [tdp_action(tdp_input.keyboard, vk_escape), tdp_action(tdp_input.keyboard, vk_backspace)]);
	...
	tdp_input_ini_read("menu_back", [tdp_action(tdp_input.keyboard, ord("X")), tdp_action(tdp_input.keyboard, vk_escape), tdp_action(tdp_input.keyboard, vk_backspace)]);
